...
public class CircleDrawing extends Drawing {
    ...
    public CircleDrawing(int x, int y, int width, int height, Color color, boolean fromLoad) {
        super(x, y, width, height, color);
        shape = new Ellipse2D.Double(x1,y1,width,height);
    }
    
    public CircleDrawing(int x, int y, int width, int height, Color color) {
        super(x, y, width, height, color);
        ...
        shape = new Ellipse2D.Double(X, Y, corner, corner);
